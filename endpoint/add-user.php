...
try {
    ...
    if (empty($nameExist)) {
        ...
        $insertStmt = $conn->prepare("INSERT INTO `tbl_user` (`tbl_user_id`, `first_name`, `last_name`, `contact_number`, `email`, `address`, `state`, `username`, `password`) VALUES (NULL, :first_name, :last_name, :contact_number, :email, :address, :state, :username, :password)");
